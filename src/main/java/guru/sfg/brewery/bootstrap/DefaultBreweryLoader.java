...
public class DefaultBreweryLoader implements CommandLineRunner {
    ...
    private BeerOrder createOrder(Customer customer) {
        return  beerOrderRepository.save(BeerOrder.builder()
                ...
                .beerOrderLines(Stream.of(BeerOrderLine.builder()
    ...
    private void loadTastingRoomData() {
        ...
        beerRepository.findAll().forEach(beer -> {
            Set beerOrderLines = new HashSet<>();
    ...
    private void loadSecurityData() {
        ...
        Authority updataBeer = authorityRepository.save(Authority.builder().permission("beer.update").build());
        ...
        adminRole.setAuthorities(Stream.of(
                createBeer, updataBeer, deleteBeer, readBeer,
                createCustomer,deleteCustomer,updateCustomer,readCustomer,
                createBrewery,deleteBrewery,updateBrewery,readBrewery,
                createOrder,deleteOrder,updateOrder,readOrder,pickupOrder)
                .collect(Collectors.toSet()));
        customerRole.setAuthorities(Stream.of(readBeer,readBrewery,readCustomer,
                createOrderCustomer,deleteOrderCustomer,readOrderCustomer,updateOrderCustomer,pickupOrderCustomer)
                .collect(Collectors.toSet()));
